...
function TodoSidbar() {
    const navShow = useOutletContext();
    ...
    return (
        <>
            ...
            <nav id="sidebarMenu" className={`collapse d-lg-block ${navShow.open?'d-block':''} sidebar bg-white overflow-auto`}>
                <div className="position-sticky">
                    <div className='d-flex justify-content-between align-items-center p-3 pb-2'>
                        ...
                        <div className='d-lg-none'>
                            <button className='btn btn-outline-light' onClick={() => navShow.setOpen(!open)}>
